...
# -- Project information -----------------------------------------------------
project = '{{ cookiecutter.display_name }}'
...
latex_documents = [
    (master_doc, 'SampleProject.tex', '{{ cookiecutter.display_name }} Documentation',
     '{{ cookiecutter.copyright_holder }}', 'manual'),
]
...
man_pages = [
    (master_doc, 'sampleproject', '{{ cookiecutter.display_name }} Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SampleProject', '{{ cookiecutter.display_name }} Documentation',
     author, 'SampleProject', '{{ cookiecutter.short_description }}',
     'Miscellaneous'),
]
